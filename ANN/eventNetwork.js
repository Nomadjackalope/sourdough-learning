...
//     // PROBLEM if output of a nueron is 0 then nothing has activated so error must propogate to all inputs
...
//         connection.toAddWeight = 1.0 * val * connection.weight * connection.activatedPct; // activatedPct? // * connection.weight 
...
//                 curCon = curNeuron.connectionsIn[curNeuron.numConnectionsInUsed]
//                 // console.log("conOutUsed: " + curNeuron.numConnectionsOutUsed);
//                 // console.log("conOutLen: " + (curNeuron.connectionsOut.length) );
//                 if (curCon.activatedPct > 0) {
                    
//                     //curCon.toAddWeight = 1.0 * curNeuron.dsigmoidedVal * (curCon.weight/weightOActiveCons) * curCon.activatedPct;
                    
                    
//                     backProp(curCon, curNeuron.dsigmoidedVal);
//                 }
//                 // Increase connections used
...
//     // ActivatedVal in place of sigmoidedVal works better
...
//         if(element.nodeB.id == 8) {
//             //console.log(element.nodeA.id, element.nodeB.id, ":", element.toAddWeight)
//         }
